  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="Dashboard/index.html">
          <h1 class="text-primary font-weight-bold" style="font-size: 24px;">QuickFresh</h1>
        </a>
        <a class="navbar-brand brand-logo-mini" href="Dashboard/index.html">
          <h1 class="text-primary font-weight-bold" style="font-size: 20px;">QF</h1>
        </a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div id="right-sidebar" class="settings-panel">
        ...
        <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="todo-tab" data-toggle="tab" href="Dashboard/Dashboard/#todo-section" role="tab" aria-controls="todo-section" aria-expanded="true">TO DO LIST</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="chats-tab" data-toggle="tab" href="Dashboard/Dashboard/#chats-section" role="tab" aria-controls="chats-section">CHATS</a>
          </li>
        </ul>
      ...
      <nav class="sidebar sidebar-off canvas position-fixed" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('driver')}}">Table Driver</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('tablePelanggan')}}">Table Pelanggan</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('foods')}}">Food</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
